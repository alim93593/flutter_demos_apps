...
class IconBroken{
  ...
  static const Video = IconData(0xe95c,fontFamily: _fontFamily);
  static const Voice_2 = IconData(0xe95d,fontFamily: _fontFamily);
  static const Voice = IconData(0xe95e,fontFamily: _fontFamily);
  static const Volume_Down = IconData(0xe95f,fontFamily: _fontFamily);
  static const Volume_Off = IconData(0xe960,fontFamily: _fontFamily);
  static const Volume_Up = IconData(0xe961,fontFamily: _fontFamily);
  static const Wallet = IconData(0xe962,fontFamily: _fontFamily);
  static const Work = IconData(0xe963,fontFamily: _fontFamily);
}